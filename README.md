...
**WinDash (v1) is no longer under active development.**  
This repository is kept for reference and for existing users, but no new features or fixes are planned.

Development has moved to **WinDash 2**, a complete rewrite with a native Windows implementation and a more seamless experience.

👉 **WinDash 2 (active development):**  
https://github.com/DavevanIersel/WinDash2

If you’re new to WinDash, or looking for the latest version, you should use **WinDash 2** instead.
