...
export interface Widget {
  ...
  customUserAgent: [{ domain: string, userAgent: string }];     // Mapping of domains to custom user agents (Some widget will make calls to different websites, which might require different user agents. CloudFlare or Google Login requests for example)
